...
{   
    ...
    while(!pq.empty()){
        ...
        for(auto ch : adj[parnode])
        {
            ...
            if(dist[parnode].first + wt == dist[child].first){
                dist[child].second += dist[parnode].second ;
            }
            else if(dist[parnode].first + wt < dist[child].first){
                dist[child].first = dist[parnode].first + wt ; 
                dist[child].second = dist[parnode].second ;
                pq.push({dist[child].first, child}) ;
            }
        }
    }
}
